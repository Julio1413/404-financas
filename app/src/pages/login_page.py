...
def login_page_2(page):
    ...
    #Campos de entrada
    nome = ft.TextField(label="Nome", border_radius=40, focused_border_color=ft.Colors.INDIGO_300,expand=True,hint_text="Digite seu nome",keyboard_type=ft.KeyboardType.TEXT)
    telefone = ft.TextField(label="Telefone", border_radius=40, focused_border_color=ft.Colors.INDIGO_300,expand=True,hint_text="Digite seu telefone",keyboard_type=ft.KeyboardType.PHONE)
